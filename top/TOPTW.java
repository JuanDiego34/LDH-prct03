/**
 * @file TOPTW.java
 * @brief Contiene la implementación de la clase TOPTW, que representa una instancia del problema TOPTW.
 */
...
/**
 * @class TOPTW
 * @brief Clase que representa una instancia del problema TOPTW (Time-Dependent Orienteering Problem with Time Windows).
 */
public class TOPTW {
    private int nodes;
    private double[] x;
