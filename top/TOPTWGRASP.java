 ...
 * @brief Contiene la implementación de la clase TOPTWGRASP, que realiza una búsqueda GRASP para resolver un problema de rutas de vehículos con ventanas de tiempo (TOPTW).
 */
...
/**
 * @class TOPTWGRASP
 * @brief Implementa el algoritmo Greedy Randomized Adaptive Search Procedure (GRASP) para resolver el problema TOPTW.
 */
public class TOPTWGRASP {
    /**
     * Valor que se utiliza para marcar soluciones no evaluadas.
     */
     ...
     * @param sol La solución inicial del problema TOPTW.
     */
