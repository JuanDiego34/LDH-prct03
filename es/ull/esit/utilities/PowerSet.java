/**
 * @file PowerSet.java
 * @brief Contiene la implementación de la clase PowerSet, que se utiliza para calcular todos los subconjuntos de un conjunto dado.
 */
...
/**
 * @class PowerSet<E>
 * @brief Clase que permite calcular todos los subconjuntos de un conjunto dado.
 * @tparam E Tipo de elementos en el conjunto.
 */
